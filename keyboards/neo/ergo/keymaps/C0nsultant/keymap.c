...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_B] = LAYOUT_hot( /* Base */
        ...
        KC_END,  KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_B,    KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RSFT,
                 KC_LCTL, KC_LGUI,          KC_LALT,          KC_SPC,                             KC_SPC,          KC_RALT,         MO(WIN_F),KC_RGUI, KC_RCTL
    ),
    ...
    [WIN_F] = LAYOUT_hot( /* FN */
        _______, QK_BOOT, KC_BRID, KC_BRIU, KC_MYCM, _______, _______, _______,          _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,
    ...
    [MAC_B] = LAYOUT_hot( /* Base */
        ...
        KC_END,  KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_B,    KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RSFT,
                 KC_LCTL, KC_LOPT,          KC_LCMD,          KC_SPC,                             KC_SPC,          KC_RCMD,         MO(MAC_F),KC_ROPT, KC_RCTL
    ),

    [MAC_U] = LAYOUT_hot( /* Umlauts */
        _______,  KC_GRV,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,            KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______,  KC_DEL,
    ...
    [MAC_F] = LAYOUT_hot( /* FN */
        _______, QK_BOOT, KC_BRID, KC_BRIU, KC_MCTL, _______, _______, _______,          _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,
