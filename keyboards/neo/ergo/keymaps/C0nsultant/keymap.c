...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_B] = LAYOUT_hot( /* Base */
        ...
        KC_END,  KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_B,    KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,MO(WIN_F),
                 KC_LCTL, KC_LGUI,          KC_LALT,          KC_SPC,                             KC_SPC,          KC_RALT,          KC_RGUI, XXXXXXX, KC_RCTL
    ),
    ...
    [WIN_U] = LAYOUT_hot( /* Umlauts */
        ...
        _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______,MO(WIN_F),
    ...
    [MAC_B] = LAYOUT_hot( /* Base */
        ...
        KC_END,  KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_B,    KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,MO(MAC_F),
                 KC_LCTL, KC_LALT,          KC_LGUI,          KC_SPC,                             KC_SPC,          KC_RGUI,          KC_RALT, _______, KC_RCTL
    ),
    ...
    [MAC_U] = LAYOUT_hot( /* Umlauts */
        ...
        _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, MO(MAC_F),
                 _______, _______,          _______,          _______,                            _______,          _______,          _______, _______, _______
    ),
