...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_U] = LAYOUT_hot( /* Umlauts */
        ...
        _______, _______, WIN_AE,  WIN_SZ,  _______, _______, _______,                   _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [MAC_B] = LAYOUT_hot( /* Base */
        ...
        KC_END,  KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_B,    KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_UP,   KC_RSFT,
                 KC_LCTL, KC_LGUI,          KC_LALT,          KC_SPC,                             KC_SPC,         MO(MAC_F),         KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    ...
    [MAC_U] = LAYOUT_hot( /* Umlauts */
        ...
        _______, _______, MAC_AE,  MAC_SZ,  _______, _______, _______,                   _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______,
